...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    return (
        <div
            className="w-full bg-black font-sans dark:bg-neutral-950 md:px-10"
            ref={containerRef}
        >
            <div className="mx-auto max-w-7xl px-4 py-20 md:px-8 lg:px-10">
                <h2 className="mb-4 max-w-4xl text-lg text-white dark:text-white md:text-4xl">
                    How It Works
                </h2>
                <p className="max-w-sm text-sm text-white dark:text-neutral-300 md:text-base">
                    Code smarter, collaborate faster, and build together with
                    CodeNexus!
                </p>
            </div>
